class ActivitiesController < ApplicationController
 ...
 def destroy
  ...
  private
  def activity_params
    params.require(:activity).permit(:bi_weekly_recurring, :image, :capacity, :contact_email, :contact_number, :activity_name, :content, :category, :additional_info, :cost, :start_date, :end_date, :picture, :addressLN1, :addressLN2, :city, :state, :zip, images: [])
  end
