class ActivitiesController < ApplicationController
  ...
  def create
    ...
    p activity_params[:account_number]
 ...
 def destroy
  ...
  private
  def activity_params
    params.require(:activity).permit(:image, :account_number, :routing_number, :capacity, :contact_email, :contact_number, :activity_name, :content, :category, :additional_info, :cost, :start_date, :end_date, :picture, :addressLN1, :addressLN2, :city, :state, :zip)
  end
